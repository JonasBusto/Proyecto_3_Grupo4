...
const ArticlePageDb = () => {
  ...
  const indexFoundDb = placesDb.findIndex((l) => l.id === Number(paramsId.id));
  const [objetoPrueba, setObjetoPrueba] = useState({});
  setObjetoPrueba(placesDb[indexFoundDb]);

  useEffect(() => {
   console.log(objetoPrueba)
    if (objetoPrueba === undefined) {
  ...
  //   if(objetoPrueba){
  //    console.log(objetoPrueba.img.img1);}
    ...
    <>
      <div>
            ...
            <div className="row m-0 h-100 mx-auto">
              <div className="col-12 col-md-8 d-flex align-items-center justify-content-center">
                <div className="div-title-place">
                  <h1 className="title-place">
                    ...
                    <b className="text-orange">{objetoPrueba.namePlace}</b>
                  </h1>
              ...
              <div className="col-12 col-md-4 d-none d-md-flex flex-column align-items-center justify-content-center div-detail-hero">
                <div className="div-title-place2">
                  ...
                  <p>
                    Categoria:{" "}
                    <b className="text-orange">{objetoPrueba.category}</b>
                  </p>
                  <p>
                    Provincia:{" "}
                    <b className="text-orange">{objetoPrueba.province}</b>
                  </p>
                </div>
              </div>
            </div>
        ...
        <p className="mx-2 p-anchor-head-links mt-3">
          ...
          <b className="mx-2">/</b>
          <span>{objetoPrueba.namePlace}</span>
        </p>
        <div className="mx-auto" style={{ maxWidth: "1300px" }}>
              ...
              <div>
                ...
                >
                  ...
                  <Modal.Body className="modal-b-admin">
                    <Formik
                      initialValues={{
                        category: objetoPrueba.category,
                        province: objetoPrueba.province,
                      }}
                        ...
                        <Form onSubmit={handleSubmit}>
                          <div className="row m-0">
                            <p>
                              ...
                              {objetoPrueba.category.toUpperCase()}
                            </p>
                            <p>
                              Provincia seleccionada:{" "}
                              {objetoPrueba.province.toUpperCase()}
                            </p>
          ...
          <div className="p-2 d-block d-md-none div-box">
            ...
            <p>1. Valoración: </p>
            <p>2. Categoria: {objetoPrueba.category} </p>
            <p>3. Provincia: {objetoPrueba.province}</p>
            <p>4. Me gusta: </p>
          </div>
